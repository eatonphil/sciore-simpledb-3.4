 ...
 */
public class Term {
  public static final int EQ=0, LT=1, GT=2, IS=3;  // added for hw9
  private Expression lhs, rhs;
  private int op; // added for hw9

  // keep this for backwards compatability
  public Term(Expression lhs, Expression rhs) {
	this.lhs = lhs;
	this.rhs = rhs;
	this.op = EQ; // added for hw9
  }

  // added for hw9
  public Term(Expression lhs, int op, Expression rhs) {
	this.lhs = lhs;
	this.rhs = rhs;
	this.op = op;
  }
...
// MODIFY THIS METHOD FOR HW 9
   public String toString() {
      return lhs.toString() + "=" + rhs.toString();
   }

   // The remaining methods are modified for hw9
	...
	public int reductionFactor(Plan p) {
		...
		// assume that non-equality preds reduce the size by half.
		if (op != EQ) // added for hw9
			return 2; 
